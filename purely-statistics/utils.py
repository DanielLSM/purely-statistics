...
def arrays_to_pdf(ndarray1,ndarray2,bins):
    #use the bins of the larger array
    min_array = ndarray1.min() if ndarray2.min()>ndarray1.min() else ndarray2.min()
    max_array = ndarray1.max() if ndarray2.max()<ndarray1.max() else ndarray2.max()
...
def KL(ndarray1,ndarray2,bins=50):
    p, q = arrays_to_pdf(ndarray1,ndarray2,bins)
